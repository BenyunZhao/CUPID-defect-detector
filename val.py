...
if __name__ == '__main__':
    # 加载模型
    model = YOLO('/home/claude/Documents/GitHub/yolov8/runs-seg/CUPIDn/weights/best.pt')
    # 验证模型
    metrics=model.val(
        val=True,  # (bool) 在训练期间进行验证/测试
        data='/home/claude/Documents/GitHub/yolov8/ultralytics/cfg/datasets/CR.yaml',
        ...
        project='runs-seg/test',  # 项目名称（可选）
        name='CUPIDn',  # 实验名称，结果保存在'project/name'目录下（可选）
